	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="mb-3">
				...
				<input name="instagram" type="text" class="form-control" placeholder="Instagram do Site" value="<?php echo $instagram_sistema ?>">
			</div>
		</div>
		<div class="col-md-4">
			<div class="mb-3">
				<label for="exampleFormControlInput1" class="form-label">Twitter</label>
				<input name="twitter" type="text" class="form-control" placeholder="Twitter do Site" value="<?php echo $twitter_sistema ?>">
			</div>
		</div>
	</div>
	...
	<div class="row">
		...
		<div class="col-md-3">
			<div class="mb-3">
				...
				<input name="linkedin" type="text" class="form-control" placeholder="Linkedin do Site" value="<?php echo $linkedin_sistema ?>">
			</div>
		</div>
		<div class="col-md-3">
			<div class="mb-3">
				<label for="exampleFormControlInput1" class="form-label">Youtube</label>
				<input name="youtube" type="text" class="form-control" placeholder="Youtube do Site" value="<?php echo $youtube_sistema ?>">
			</div>
		</div>
		<div class="col-md-3">
			<div class="mb-3">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="mb-3">
				...
				<input name="texto_rodape" type="text" class="form-control" placeholder="Texto Rodapé do Site" value="<?php echo $texto_rodape ?>">
			</div>
		</div>
	</div>
	<div class="row">
		<div class="col-md-4">
			<div class="mb-3">
				...
				<input name="titulo_contato" type="text" class="form-control" placeholder="Título Contato" value="<?php echo $titulo_contato ?>">
			</div>
		</div>
		<div class="col-md-8">
			<div class="mb-3">
				<label for="exampleFormControlInput1" class="form-label">Subtítulo Contato</label>
				<input name="subtitulo_contato" type="text" class="form-control" placeholder="Subtítulo Contato" value="<?php echo $subtitulo_contato ?>">
			</div>
		</div>
		<div class="row">
