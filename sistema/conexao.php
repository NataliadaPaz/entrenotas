...
$nome_sistema = 'Entre Notas';
$email_sistema = 'natydapaz1017@gmail.com';
$telefone_sistema = '(11)96087-9925';
$endereco_sistema = '';
$senha_sistema = '123';
...
$total_reg = @count($res);
if($total_reg == 0){
	$pdo->query("INSERT INTO config SET nome = '$nome_sistema', email = '$email_sistema', senha = '$senha_sistema', telefone = '$telefone_sistema', endereco = '$endereco_sistema', logo = '../img/logo.png', icone = '../img/icone.png', cor = '#00c1c1', titulo_contato = 'Contate-nos', subtitulo_contato = 'Preencha os Campos abaixo para entrar em contato conosco!'");
}else{
